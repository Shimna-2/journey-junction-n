    ...
    <div className="bg-white pt-32 pb-20 px-4 sm:px-6 lg:px-20">
      ...
      <article className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <img
            src="src/assets/images/1000119737_Pml0uYK.jpg"
            alt="Ziplining in Wayanad"
            className="rounded-lg shadow-md object-cover w-full h-64"
          />
          <img
            src="src/assets/images/chembra-trek.jpg"
            alt="Chembra Peak trekking trail"
            className="rounded-lg shadow-md object-cover w-full h-64"
          />
          <img
            src="src/assets/images/banasura-camping.jpg"
        ...
        <section className="prose lg:prose-lg max-w-none text-gray-800 leading-relaxed">
          ...
          <p>
            ...
            India. Rock climbing and rappelling are also popular, especially in
            the rugged hills near Meenmutty and Soochipara waterfalls.
          </p>
          ...
          <p>
            ...
            mountain roads offer unmatched thrills. Routes through Kuruva Island
            and Edakkal Caves combine adventure with sightseeing.
          </p>

          <h2>Water Adventures</h2>
          <p>
            Kayaking in the backwaters of Pozhuthana and rafting in Kabini River
            during the monsoon offer a mix of excitement and scenic beauty.
          </p>

          <h2>Best Time for Adventure</h2>
          <p>
            October to May is ideal for most adventure activities, while the
            monsoon months are perfect for water-based adventures like rafting.
          </p>
          ...
          <p>
            ...
            the peace of camping under the stars, Wayanad promises an adventure
            for every traveler. It’s the perfect blend of adrenaline and
            serenity in one of Kerala’s most stunning landscapes.
          </p>
        </section>
      </article>
    </div>
