      ...
      <article className="max-w-7xl mx-auto pt-28 px-4 sm:px-6 lg:px-12 bg-white shadow-xl rounded-xl p-6 sm:p-8">
        ...
        <header className="mb-8 text-center max-w-prose mx-auto">
          ...
          <p className="text-base sm:text-lg text-gray-600">
            Nestled deep within the forests of the Brahmagiri Hills in Wayanad,
            Kerala, Thiruneli Temple is an ancient spiritual landmark dedicated
            to Lord Vishnu. Known as the “Kashi of the South,” it is celebrated
            for its sacred rituals, mythological origins, and breathtaking
            mountain setting.
          </p>
        </header>
        ...
        {/* Intro Section */}
        <section className="text-base sm:text-lg text-gray-800 leading-relaxed mb-10 space-y-4 max-w-prose mx-auto">
          <p>
            Thiruneli Temple is believed to be over a thousand years old and is
            steeped in legends that connect it to Lord Brahma himself. The
            ...
            destination for travelers seeking a blend of spirituality, history,
            and nature.
          </p>
          <p>
        ...
        {/* Main Content */}
        <section className="text-base sm:text-lg text-gray-800 leading-relaxed space-y-6 max-w-prose mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold">History & Legends</h2>
          <p>
          ...
          <p>
            ...
            spiritual essence of the place, blending perfectly with the natural
            surroundings of forests and hills.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold">
            The Sacred Papanasini
          </h2>
          <p>
            Flowing from the Brahmagiri Hills, the Papanasini stream is believed
            to have divine powers to absolve sins. Pilgrims bathe here before
            offering prayers, and the waters are used for ancestral rituals
            called <em>Bali Tharpanam</em>.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold">Festivals & Rituals</h2>
          <p>
          ...
          <p>
            Thiruneli Temple is located about 32 km from Mananthavady in Wayanad
            and is accessible via scenic mountain roads. The nearest airport is
            Calicut International Airport (~137 km), and the nearest railway
            station is at Kozhikode (~120 km).
          </p>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Carry an extra set of clothes if you plan to bathe in Papanasini.
            </li>
          ...
          <p>
            ...
            embodiment of Kerala’s ancient culture, architecture, and spiritual
            traditions. Whether you are a pilgrim or a traveler, the serene
            atmosphere and sacred legends of Thiruneli leave a lasting mark on
            your soul.
          </p>
        </section>
      </article>
